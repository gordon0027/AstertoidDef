...
namespace ShmupBoss
{
    ...
    public class Enemy : AgentCollidable, IInGamePool
    {
        ...
        [Space]
        [Tooltip("Prints a Debug.Log message when the enemy is unable to find its pool. " +
            "In certain versions of Unity this will also be printed randomly when a level is restared.")]
        [SerializeField]
        protected bool isPrintingEnemyPoolDebug;
