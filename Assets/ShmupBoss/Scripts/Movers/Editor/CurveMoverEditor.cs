...
namespace ShmupBossEditor
{
    ...
    public class CurveMoverEditor : EditorTools
    {
        ...
        private void DrawControlPoints()
        {
            ...
            {
                var fmh_80_77_638933839391191154 = Quaternion.identity; Vector2 pos = Handles.FreeMoveHandle(path.ControlPoints[i], handleSize.floatValue, Vector2.zero, DoubleCircleHandleCap);
