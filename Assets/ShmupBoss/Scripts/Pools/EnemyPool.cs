    ...
    [SerializeField]
        ...
        private void CreatePlaceholders()
        {
            for (int i = 0; i < transform.childCount; i++)
            {
                ...
                PlaceholderInstance.transform.SetParent(Treadmill.Instance.PlaceholdersOnTreadmillHierarchy);
            }
        }
        ...
        private static GameObject CreateGroundAdversaryPlaceholder(GameObject go)
        {
            ...
            PlaceholderInstance.AddComponent<Rigidbody2D>().bodyType = RigidbodyType2D.Kinematic;
        ...
        public override void Despawn(GameObject go)
        {
            ...
            go.transform.SetParent(PoolHierarchy);
        }
